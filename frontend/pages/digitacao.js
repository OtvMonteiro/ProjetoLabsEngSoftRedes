...
class Digitacao extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await axios.post('http://localhost:5000/api/load_digitacao', {'nome_digitador': Cookies.get('nomeDoUsuario')});
  ...
  async onSubmitHandler(campo_text) {
    ...
    const post_response = await axios.post('http://localhost:5000/api/continue_digitacao', {formdata})
